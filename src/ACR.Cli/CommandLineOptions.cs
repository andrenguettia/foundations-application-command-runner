...
{
    [Option("customer-id", Required = true, HelpText = "Assigns a customer ID to the order.")]
    public string CustomerId { get; set; }

    [Option("total-amount", Required = true, HelpText = "Specifies the total amount for the order.")]
    public decimal TotalAmount { get; set; }

    [Option("currency-code", Required = true, HelpText = "Specifies the currency code for the order.")]
